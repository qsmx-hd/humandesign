...
const GATES_DATA = [
  ...
  },
  {
    ...
    circuit: "个体回路 → 觉知回路",
    opposite: 15,
    channel: "10-20 觉醒的通道 / 10-34 探索的通道 / 10-57 完美形式的通道",
    keywords: ["自我行为", "真实性", "爱自己", "觉醒", "原则"],
  ...
  },
  {
    ...
    circuit: "个体回路 → 觉知回路",
    opposite: 34,
    channel: "10-20 觉醒的通道 / 20-34 魅力的通道 / 20-57 脑波的通道",
    keywords: ["当下", "存在", "表达", "觉知", "冥想"],
  ...
  },
  {
    ...
    circuit: "个体回路 → 觉知回路",
    opposite: 43,
    channel: "20-23 合成的通道 / 43-23 构建的通道",
    keywords: ["天才", "疯狂", "突变", "分裂", "独特"],
  ...
  },
  {
    ...
    circuit: "个体回路 → 觉知回路",
    opposite: 46,
    channel: "25-51 神圣傻瓜的通道",
    keywords: ["天真", "宇宙之爱", "无条件", "精神", "疗愈"],
  ...
  },
  {
    ...
    circuit: "个体回路 → 觉知回路",
    opposite: 20,
    channel: "10-34 探索的通道 / 20-34 魅力的通道 / 34-57 生存的通道",
    keywords: ["力量", "独立", "忙碌", "本能", "行动"],
  ...
  },
  {
    ...
    circuit: "集体回路 → 感知回路",
    opposite: 32,
    channel: "3-42 未成熟的通道 / 53-42 循环的通道",
    keywords: ["完成", "周期", "成长", "总结", "圆满"],
  ...
  },
  {
    ...
    circuit: "个体回路 → 觉知回路",
    opposite: 51,
    channel: "20-57 脑波的通道 / 34-57 生存的通道 / 10-57 完美形式的通道",
    keywords: ["直觉", "清晰", "当下", "生存", "洞察"],
